...
import { languageInfo, localizedPath, type Locale } from '@/lib/i18n/config'
...
export default function SiteRoot({
  ...
  return (
    <html lang={languageInfo[locale].lang} suppressHydrationWarning className={notoSansTc.variable}>
      <head>
        <link rel="dns-prefetch" href="https://www.googletagmanager.com" />
        <link rel="dns-prefetch" href="https://www.google-analytics.com" />

        {/* 低成本內容摘要；Google 官方文件明確說明不採用 llms.txt 作為排名訊號。 */}
        <link rel="alternate" type="text/plain" href={localizedPath('/llms.txt', locale)} title="LLMs.txt" />
        <link rel="alternate" type="text/plain" href={localizedPath('/llms-full.txt', locale)} title="LLMs Full Content Summary" />
        ...
        <meta httpEquiv="content-language" content={languageInfo[locale].lang} />
        <meta name="language" content={languageInfo[locale].name} />
