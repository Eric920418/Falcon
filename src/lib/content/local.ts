  ...
  'taoyuan-seo': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '我們的 SEO 方案不分區域：基礎方案 7,500 / 月、進階方案 15,000 / 月、企業方案 30,000 / 月。詳細內容見「SEO 搜尋引擎優化」服務頁。',
      },
      {
  ...
  'taipei-digital-marketing': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '我們的定價全國統一：小型方案 0.75-1.25 萬 / 月、中型方案 1.25-3.75 萬 / 月、企業方案 5 萬以上 / 月。',
      },
      {
        question: '可以只做單項服務嗎？',
        answer:
    ...
    faq: [
      {
        question: '台北 SEO 行情？',
        answer:
          'SEO 廠商定價差異很大，從幾千元到幾十萬都有。我們的方案：基礎 7,500、進階 15,000、企業 30,000，全國統一定價；簽約前應比較實際工作範圍。',
      },
      {
    ...
    faq: [
      {
        question: '新竹網頁設計多少錢？',
        answer:
          '科技業客製化網站起價約 3.75 萬（中型企業官網），複雜需求 7.5 萬以上（多語、招募系統、產品配置工具）。',
      },
      {
        question: '可以簽 NDA 嗎？',
        answer:
